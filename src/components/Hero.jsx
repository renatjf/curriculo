  ...
  return (
    <section className={styles.hero} id="hero">
      <div className={styles.parallaxLayer} ref={parallaxRef}>
        <div className={styles.bgText} aria-hidden="true">DEV</div>
      </div>

      <div className={`container ${styles.content}`}>
        <div className={styles.left}>
          <p className={`section-tag ${styles.tag}`} style={{ animationDelay: '0.1s' }}>
            Currículo Profissional
          </p>
          <h1 className={styles.name}>
            {personal.nome.split(' ').map((word, i) => (
              <span key={i} className={styles.nameWord} style={{ animationDelay: `${0.2 + i * 0.08}s` }}>
                {word}
              </span>
            ))}
          </h1>
        ...
        <div className={styles.right} style={{ animationDelay: '0.3s' }}>
          <div className={styles.photoFrame}>
            ...
            <img src={personal.foto} alt={personal.nome} className={styles.photo} />
